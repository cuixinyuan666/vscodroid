...
object Environment {
    ...
    fun buildProcessEnvironment(context: Context, port: Int): Map<String, String> {
        ...
        val base = mapOf(
            ...
            "OPENCODE_EXPERIMENTAL_DISABLE_FILEWATCHER" to "true",
            "TEMP" to tmpDir,
            "TMP" to tmpDir,
            "BUN_TMPDIR" to tmpDir,
            "XDG_CACHE_HOME" to "$homeDir/.cache",
            "XDG_DATA_HOME" to "$homeDir/.local/share",
            "XDG_STATE_HOME" to "$homeDir/.local/state",
            "XDG_CONFIG_HOME" to "$homeDir/.config",
